...
const u8 gMonIconPaletteIndices[NUM_SPECIES] =
{
	...
	[SPECIES_BASCULEGION_M] = 0x1,
	[SPECIES_BASCULEGION_F] = 0x0,
	[SPECIES_SNEASLER] = 0x2,
	[SPECIES_OVERQWIL] = 0x2,
	[SPECIES_ENAMORUS] = 0x1,
	[SPECIES_ENAMORUS_THERIAN] = 0x1,
	//New Species Go Here

	[SPECIES_MELMETAL_MEGA] = 0x2,
    [SPECIES_CYCLIZAR] = 0x1,
    [SPECIES_ANNIHILAPE] = 0x0,
    [SPECIES_FARIGIRAF] = 0x0,
    [SPECIES_DUDUNSPARCE] = 0x0,
    [SPECIES_KINGAMBIT] = 0x0,
    [SPECIES_ROARING_MOON] = 0x0,
    [SPECIES_IRON_VALIANT] = 0x1,
    [SPECIES_KORAIDON] = 0x0,
    [SPECIES_MIRAIDON] = 0x2,
	[SPECIES_WALKING_WAKE] = 0x2,
	[SPECIES_IRON_LEAVES] = 0x1,
    [SPECIES_LUGIA_SHADOW] = 0x0,
};
